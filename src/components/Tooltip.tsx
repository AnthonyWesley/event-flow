...
export default function Tooltip({
  ...
  return (
    <div className="group relative flex">
      ...
      {info && (
        <div className="absolute -top-14 left-1/2 z-40 min-w-35 -translate-x-1/2 scale-0 transform rounded-lg bg-gray-900 p-2 text-xs font-medium text-white shadow-lg transition-transform duration-300 ease-in-out group-hover:scale-100">
